...
export class Schedule {
    constructor(private registry: SchedulerRegistry, private schedulerOrchestrator: SchedulerOrchestrator) {}
    ...
    public createIntervalJob(methodRef: Function, interval: number, options: IntervalOptions = {}) {
        const name = options.name || v4();
