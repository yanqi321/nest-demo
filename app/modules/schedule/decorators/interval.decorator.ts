...
import { SCHEDULER_NAME, SCHEDULER_TYPE, SCHEDULE_INTERVAL_OPTIONS, SCHEDULER_OPTIONS } from '../schedule.constants';
 ...
 * Schedules an interval (`setInterval`).
 */
export function Interval(name: string, interval: number, options?: IntervalOptions): MethodDecorator;
/**
 * Schedules an interval (`setInterval`).
 */
