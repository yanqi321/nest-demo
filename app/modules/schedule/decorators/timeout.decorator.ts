...
import { SCHEDULER_NAME, SCHEDULER_TYPE, SCHEDULE_TIMEOUT_OPTIONS, SCHEDULER_OPTIONS } from '../schedule.constants';
...
export function Timeout(nameOrTimeout: string | number, timeout?: number, options?: TimeoutOptions): MethodDecorator {
    const [name, timeoutValue] = isString(nameOrTimeout) ? [nameOrTimeout, timeout] : [undefined, nameOrTimeout];
